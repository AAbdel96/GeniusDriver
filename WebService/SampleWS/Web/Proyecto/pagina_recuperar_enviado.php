...
<html lang="es"><!-- InstanceBegin template="/Templates/index_plantilla.dwt" codeOutsideHTMLIsLocked="false" -->
	<head>
		...
		<title>Genius Driver - Envio de enlace</title>
        <!-- InstanceEndEditable -->
	...
	<body>
        ...
        <section id="contenido-principal">
            ...
            <article id="contrasena-enviada">
            	<h1>Envio de enlace</h1>
                <form>
                    <label>Tu contraseña ha sido enviada correctamente!</label>
                    <div class="imagen-posicion">
                        <img class="imagen-tamaño" src="img/img-ok.png" alt="">
                    </div>
                    
                    <input type="submit" name="button" value="Aceptar" class="aceptar-button">
                </form>
            </article>
            <!-- InstanceEndEditable -->
        </section>
