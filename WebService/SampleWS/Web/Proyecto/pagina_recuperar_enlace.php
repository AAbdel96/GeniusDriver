...
<html lang="es"><!-- InstanceBegin template="/Templates/index_plantilla.dwt" codeOutsideHTMLIsLocked="false" -->
	<head>
		...
		<title>Genius Driver - Envio de contraseña nueva</title>
        <!-- InstanceEndEditable -->
	...
	<body>
        ...
        <section id="contenido-principal">
            ...
            <article id="recuperar-enlace">
            	<h1>Correo electronico</h1>
                
                <form method="post" >
                	<label>Introduce el correo electronico asociado a la cuenta.</label>
                    <input type="email" name="correo" class="recuadro-input" placeholder="Correo electronico" autofocus>
                    
                    <input type="submit" value="Enviar" class="enlace-button">
                </form>
            </article>
            <!-- InstanceEndEditable -->
        </section>
