...
<html lang="es"><!-- InstanceBegin template="/Templates/index_plantilla.dwt" codeOutsideHTMLIsLocked="false" -->
	<head>
		...
		<title>Bienvenido a Genius Driver - Lugar de la innovación y la conducción alternativa</title>
        <!-- InstanceEndEditable -->
            ...
            <section id="posicion-slider">
                <div class="recuadro-slider">
                    <div class="contenido-slider">
                        <article><img src="img/1.jpg" alt=""></article>
                        <article><img src="img/2.jpg" alt=""></article>
                        <article><img src="img/3.jpg" alt=""></article>
                        <article><img src="img/4.jpg" alt=""></article>
                    </div>
                </div>
