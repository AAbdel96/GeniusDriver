...
public class ImageUploadActivity extends ActionBarActivity {
		...
		camara.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				...
				if(!nombreImagen.getText().toString().trim().equalsIgnoreCase("")){
					...
					Toast.makeText(ImageUploadActivity.this, "Debe nombrar el archivo primero", 
	...
	private void uploadFoto(String imag){       
        ...
        HttpPost httppost = new HttpPost("http://192.168.0.112/SampleWS/upload.php");
	...
	private boolean onInsert(){
        ...
        httppost= new HttpPost("http://192.168.0.112/SampleWS/insertImagen.php"); // Url del Servidor
        //A�adimos nuestros datos
        nameValuePairs = new ArrayList<NameValuePair>(2);
        nameValuePairs.add(new BasicNameValuePair("ruta_imagen",nombreImagen.getText().toString().trim()+".jpg"));
		nameValuePairs.add(new BasicNameValuePair("email",getIntent().getStringExtra("correo")));
